            ...
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="form-group relative {{ $errors->first( 'title' ) ? 'has-error' : '' }}">
                        ...
                        <i class="ion-star mandatory"></i>{!! Form::text( 'title', NULL, [ 'class' => 'form-control', 'id' => 'title', 'required' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <div class="form-group relative {{ $errors->first( 'subtitle' ) ? 'has-error' : '' }}">
                        ...
                        <i class="ion-star mandatory"></i>{!! Form::text( 'subtitle', NULL, [ 'class' => 'form-control', 'id' => 'subtitle', 'required' ] ) !!}
                ...
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <div class="form-group relative {{ $errors->first( 'description' ) ? 'has-error' : '' }}">
                        ...
                        {!! Form::label( 'description', trans( 'webpage-text.create-ad-description-placeholder' ) ) !!}
                         <i class="ion-star mandatory"></i>{!! Form::textarea( 'description', NULL, [ 'class' => 'form-control', 'id' => 'description', 'required' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-md-offset-3">
                    ...
                    <div class="form-group relative {{ $errors->first( 'price' ) ? 'has-error' : '' }}">
                        ...
                        <i class="ion-star mandatory"></i>{!! Form::text( 'price', NULL, [ 'class' => 'form-control', 'id' => 'price', 'required' ] ) !!}
                ...
                <div class="col-md-2">
                    ...
                    <div class="form-group relative {{ $errors->first( 'currency' ) ? 'has-error' : '' }}">
                        ...
                        <i class="ion-star mandatory"></i>{!! Form::select( 'currency', [ '€' => '€ - EURO', '£' => '£ - GBP', '$' => '$ - USD' ], NULL, [ 'class' => 'form-control', 'id' => 'currency', 'required' ] ) !!}
                ...
                <div class="col-md-2">
                    ...
                    <div class="form-group relative {{ $errors->first( 'period' ) ? 'has-error' : '' }}">
                       ...
                       {!! Form::label( 'period', trans( 'webpage-text.create-ad-period-placeholder' ) ) !!}
                        <i class="ion-star mandatory"></i>{!! Form::select( 'period', [ trans( 'webpage-text.card-period-day' ) => trans( 'webpage-text.card-period-day' ), trans( 'webpage-text.card-period-week' ) => trans( 'webpage-text.card-period-week' ), trans( 'webpage-text.card-period-month' ) => trans( 'webpage-text.card-period-month' ) ], NULL, [ 'class' => 'form-control', 'id' => 'period', 'required' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-md-offset-3">
                    ...
                    <div class="form-group relative {{ $errors->first( 'country' ) ? 'has-error' : '' }}">
                       ...
                       {!! Form::label( 'country', trans( 'webpage-text.create-ad-country-placeholder' ) ) !!}
                        <i class="ion-star mandatory"></i>{!! Form::select( 'country', $countries, NULL, [ 'class' => 'form-control', 'id' => 'country', 'required' ] ) !!}
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group relative {{ $errors->first( 'city' ) ? 'has-error' : '' }}">
                        ...
                        <i class="ion-star mandatory"></i>{!! Form::text( 'city', NULL, [ 'class' => 'form-control', 'id' => 'city', 'required' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-md-offset-3">
                    ...
                    <div class="form-group relative {{ $errors->first( 'zip' ) ? 'has-error' : '' }}">
                        ...
                        <i class="ion-star mandatory"></i>{!! Form::text( 'zip', NULL, [ 'class' => 'form-control', 'id' => 'zip', 'required' ] ) !!}
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group relative {{ $errors->first( 'address' ) ? 'has-error' : '' }}">
                        ...
                        <i class="ion-star mandatory"></i>{!! Form::text( 'address', NULL, [ 'class' => 'form-control', 'id' => 'address', 'required' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-2">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'ramp', NULL , NULL, [ 'id' => 'ramp' ] ) !!}
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'lift', NULL , NULL, [ 'id' => 'lift' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-2">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'parking', NULL , NULL, [ 'id' => 'parking' ] ) !!}
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'garden', NULL , NULL, [ 'id' => 'garden' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-2">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'bedroom', NULL , NULL, [ 'id' => 'bedroom' ] ) !!}
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'circulation', NULL , NULL, [ 'id' => 'circulation' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-2">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'kitchen_acessible', NULL , NULL, [ 'id' => 'kitchen_acessible' ] ) !!}
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'bathroom_acessible', NULL , NULL, [ 'id' => 'bathroom_acessible' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-2">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'shower_1', NULL , NULL, [ 'id' => 'shower_1' ] ) !!}
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'shower_2', NULL , NULL, [ 'id' => 'shower_2' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-2">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'wc', NULL , NULL, [ 'id' => 'wc' ] ) !!}
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'transports', NULL , NULL, [ 'id' => 'transports' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-2">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'tv', NULL , NULL, [ 'id' => 'tv' ] ) !!}
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'home_cinema', NULL , NULL, [ 'id' => 'home_cinema' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-2">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'computer', NULL , NULL, [ 'id' => 'computer' ] ) !!}
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'internet', NULL , NULL, [ 'id' => 'internet' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'phone', NULL , NULL, [ 'id' => 'phone' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-2">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'dishwasher', NULL , NULL, [ 'id' => 'dishwasher' ] ) !!}
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'washing_machine', NULL , NULL, [ 'id' => 'washing_machine' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-2">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'dryer', NULL , NULL, [ 'id' => 'dryer' ] ) !!}
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'oven', NULL , NULL, [ 'id' => 'oven' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-2">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'fridge', NULL , NULL, [ 'id' => 'fridge' ] ) !!}
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'freezer', NULL , NULL, [ 'id' => 'freezer' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-2">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'microwave', NULL , NULL, [ 'id' => 'microwave' ] ) !!}
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group text-center">
                        ...
                        {!! Form::checkbox( 'coffee_machine', NULL , NULL, [ 'id' => 'coffee_machine' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-md-offset-3 col-sm-offset-3">
                    ...
                    <div class="form-group relative {{ $errors->first( 'livingroom' ) ? 'has-error' : '' }}">
                       ...
                       {!! Form::label( 'livingroom', trans( 'webpage-text.create-ad-room-1' ) ) !!}
                        <i class="ion-star mandatory"></i>{!! Form::text( 'livingroom', NULL, [ 'class' => 'form-control', 'style' => 'width : 60px; float : right;', 'id' => 'livingroom', 'placeholder' => trans( 'webpage-text.create-ad-nb-placeholder' ), 'required' ] ) !!}
                ...
                <div class="col-md-3 col-md-offset-1">
                    ...
                    <div class="form-group relative {{ $errors->first( 'dining_room' ) ? 'has-error' : '' }}">
                        ...
                        <i class="ion-star mandatory"></i>{!! Form::text( 'dining_room', NULL, [ 'class' => 'form-control', 'style' => 'width : 60px; float : right;', 'id' => 'dining_room', 'placeholder' => trans( 'webpage-text.create-ad-nb-placeholder' ), 'required' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-md-offset-3 col-sm-offset-3">
                    ...
                    <div class="form-group relative {{ $errors->first( 'kitchen' ) ? 'has-error' : '' }}">
                       ...
                       {!! Form::label( 'kitchen', trans( 'webpage-text.create-ad-room-3' ) ) !!}
                        <i class="ion-star mandatory"></i>{!! Form::text( 'kitchen', NULL, [ 'class' => 'form-control', 'style' => 'width : 60px; float : right;', 'id' => 'kitchen', 'placeholder' => trans( 'webpage-text.create-ad-nb-placeholder' ), 'required' ] ) !!}
                ...
                <div class="col-md-3 col-md-offset-1">
                    ...
                    <div class="form-group relative {{ $errors->first( 'kitchenette' ) ? 'has-error' : '' }}">
                        ...
                        <i class="ion-star mandatory"></i>{!! Form::text( 'kitchenette', NULL, [ 'class' => 'form-control', 'style' => 'width : 60px; float : right;', 'id' => 'kitchenette', 'placeholder' => trans( 'webpage-text.create-ad-nb-placeholder' ), 'required' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-md-offset-3 col-sm-offset-3">
                    ...
                    <div class="form-group relative {{ $errors->first( 'bathroom' ) ? 'has-error' : '' }}">
                       ...
                       {!! Form::label( 'bathroom', trans( 'webpage-text.create-ad-room-5' ) ) !!}
                        <i class="ion-star mandatory"></i>{!! Form::text( 'bathroom', NULL, [ 'class' => 'form-control', 'style' => 'width : 60px; float : right;', 'id' => 'bathroom', 'placeholder' => trans( 'webpage-text.create-ad-nb-placeholder' ), 'required' ] ) !!}
                ...
                <div class="col-md-3 col-md-offset-1">
                    ...
                    <div class="form-group relative {{ $errors->first( 'separed_wc' ) ? 'has-error' : '' }}">
                        ...
                        <i class="ion-star mandatory"></i>{!! Form::text( 'separed_wc', NULL, [ 'class' => 'form-control', 'style' => 'width : 60px; float : right;', 'id' => 'separed_wc', 'placeholder' => trans( 'webpage-text.create-ad-nb-placeholder' ), 'required' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-md-offset-3 col-sm-offset-3">
                    ...
                    <div class="form-group relative {{ $errors->first( 'garage' ) ? 'has-error' : '' }}">
                       ...
                       {!! Form::label( 'garage', trans( 'webpage-text.create-ad-room-9' ) ) !!}
                        <i class="ion-star mandatory"></i>{!! Form::text( 'garage', NULL, [ 'class' => 'form-control', 'style' => 'width : 60px; float : right;', 'id' => 'garage', 'placeholder' => trans( 'webpage-text.create-ad-nb-placeholder' ), 'required' ] ) !!}
                ...
                <div class="col-md-3 col-md-offset-1">
                    ...
                    <div class="form-group relative {{ $errors->first( 'cave' ) ? 'has-error' : '' }}">
                        ...
                        <i class="ion-star mandatory"></i>{!! Form::text( 'cave', NULL, [ 'class' => 'form-control', 'style' => 'width : 60px; float : right;', 'id' => 'cave', 'placeholder' => trans( 'webpage-text.create-ad-nb-placeholder' ), 'required' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-md-offset-3 col-sm-offset-3">
                    ...
                    <div class="form-group relative {{ $errors->first( 'double_bedroom' ) ? 'has-error' : '' }}">
                       ...
                       {!! Form::label( 'double_bedroom', trans( 'webpage-text.create-ad-room-7' ) ) !!}
                        <i class="ion-star mandatory"></i>{!! Form::text( 'double_bedroom', NULL, [ 'class' => 'form-control', 'style' => 'width : 60px; float : right;', 'id' => 'double_bedroom', 'placeholder' => trans( 'webpage-text.create-ad-nb-placeholder' ), 'required' ] ) !!}
                ...
                <div class="col-md-3 col-md-offset-1">
                    ...
                    <div class="form-group relative {{ $errors->first( 'simple_bedroom' ) ? 'has-error' : '' }}">
                        ...
                        <i class="ion-star mandatory"></i>{!! Form::text( 'simple_bedroom', NULL, [ 'class' => 'form-control', 'style' => 'width : 60px; float : right;', 'id' => 'simple_bedroom', 'placeholder' => trans( 'webpage-text.create-ad-nb-placeholder' ), 'required' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-md-offset-3 col-sm-offset-3">
                    ...
                    <div class="form-group relative {{ $errors->first( 'nb_double_bed' ) ? 'has-error' : '' }}">
                       ...
                       {!! Form::label( 'nb_double_bed', trans( 'webpage-text.create-ad-nb-double-bed-placeholder' ) ) !!}
                        <i class="ion-star mandatory"></i>{!! Form::text( 'nb_double_bed', NULL, [ 'class' => 'form-control', 'style' => 'width : 60px; float : right;', 'id' => 'nb_double_bed', 'placeholder' => trans( 'webpage-text.create-ad-nb-placeholder' ), 'required' ] ) !!}
                ...
                <div class="col-md-3 col-md-offset-1">
                    ...
                    <div class="form-group relative {{ $errors->first( 'nb_simple_bed' ) ? 'has-error' : '' }}">
                        ...
                        <i class="ion-star mandatory"></i>{!! Form::text( 'nb_simple_bed', NULL, [ 'class' => 'form-control', 'style' => 'width : 60px; float : right;', 'id' => 'nb_simple_bed', 'placeholder' => trans( 'webpage-text.create-ad-nb-placeholder' ), 'required' ] ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-md-offset-3 col-sm-offset-3">
                    ...
                    <div class="form-group relative {{ $errors->first( 'nb_baby_bed' ) ? 'has-error' : '' }}">
                       ...
                       {!! Form::label( 'nb_baby_bed', trans( 'webpage-text.create-ad-nb-baby-bed-placeholder' ) ) !!}
                        <i class="ion-star mandatory"></i>{!! Form::text( 'nb_baby_bed', NULL, [ 'class' => 'form-control', 'style' => 'width : 60px; float : right;', 'id' => 'nb_baby_bed', 'placeholder' => trans( 'webpage-text.create-ad-nb-placeholder' ), 'required' ] ) !!}
                ...
                <div class="col-md-3 col-md-offset-1">
                    ...
                    <div class="form-group relative {{ $errors->first( 'nb_sofa_bed' ) ? 'has-error' : '' }}">
                        ...
                        <i class="ion-star mandatory"></i>{!! Form::text( 'nb_sofa_bed', NULL, [ 'class' => 'form-control', 'style' => 'width : 60px; float : right;', 'id' => 'nb_sofa_bed', 'placeholder' => trans( 'webpage-text.create-ad-nb-placeholder' ), 'required' ] ) !!}
                ...
                <div class="col-md-3 col-md-offset-3 col-sm-offset-3">
                    ...
                    <div class="form-group relative {{ $errors->first( 'housing_area' ) ? 'has-error' : '' }}">
                       ...
                       {!! Form::label( 'housing_area', trans( 'webpage-text.create-ad-housing-area-placeholder' ) ) !!}
                        <i class="ion-star mandatory"></i>{!! Form::text( 'housing_area', NULL, [ 'class' => 'form-control', 'style' => 'width : 60px; float : right;', 'id' => 'housing_area', 'placeholder' => trans( 'webpage-text.create-ad-m2-placeholder' ), 'required' ] ) !!}
